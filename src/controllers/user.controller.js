...
const registerUser = asyncHandler(async (req, res) => {
    ...
    //uploa them t cloudinary,avatar
    ...
    if (!createdUser) {
        throw new ApiError(500, "Something went wrong while registring the useer")
    }
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    return res.status(200)
        .json(
            new ApiResponse(200, user, "Avatar image update done"))
})
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    return res.status(200)
        .json(
            new ApiResponse(200, user, "Cover image update done")
        )
})
...
const getWatchHistory = asyncHandler(async (req, res) => {
    ...
    .json(
        new ApiResponse(
            200,
            user[0].watchHistory,
            "Watch hustory fetched successfully"
        )
    )
})
export {
